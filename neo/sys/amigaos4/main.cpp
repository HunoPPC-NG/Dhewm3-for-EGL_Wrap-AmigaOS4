...
bool Sys_GetPath(sysPath_t type, idStr &path) {
	...
	case PATH_CONFIG:
        ...
        #ifndef __amigaos4__ //HunoPPC 2018
			idStr::snPrintf(buf, sizeof(buf), "%s/.config/dhewm3", getenv("HOME"));
        #else
            idStr::snPrintf(buf, sizeof(buf), "Doom3-Configs");
        #endif
	...
	case PATH_SAVE:
        ...
        #else
            idStr::snPrintf(buf, sizeof(buf), "Doom3-Saves");
        #endif
		path = buf;
		return true;
	...
	case PATH_EXE:
        ...
        #else
        idStr::snPrintf(buf, sizeof(buf), "PROGDIR:");
        #endif
...
int Sys_GetSystemRam( void ) {
    ...
    #endif
    #ifdef __amigaos4__ //HunoPPC 2018
    page_size = 512;
    #endif
