...
idCVar idImageManager::image_anisotropy( "image_anisotropy", "0", CVAR_RENDERER | CVAR_ARCHIVE, "set the maximum texture anisotropy if available" );
idCVar idImageManager::image_lodbias( "image_lodbias", "0", CVAR_RENDERER | CVAR_ARCHIVE, "change lod bias on mipmapped images" );
idCVar idImageManager::image_downSize( "image_downSize", "1", CVAR_RENDERER | CVAR_ARCHIVE, "controls texture downsampling" );
...
idCVar idImageManager::image_cacheMinK( "image_cacheMinK", "10240", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_INTEGER, "maximum KB of precompressed files to read at specification time" );
idCVar idImageManager::image_cacheMegs( "image_cacheMegs", "128", CVAR_RENDERER | CVAR_ARCHIVE, "maximum MB set aside for temporary loading of full-sized precompressed images" );
...
idCVar idImageManager::image_downSizeBumpLimit( "image_downSizeBumpLimit", "512", CVAR_RENDERER | CVAR_ARCHIVE, "controls normal map downsample limit" );
...
idCVar idImageManager::image_downSizeLimit( "image_downSizeLimit", "512", CVAR_RENDERER | CVAR_ARCHIVE, "controls diffuse map downsample limit" );
